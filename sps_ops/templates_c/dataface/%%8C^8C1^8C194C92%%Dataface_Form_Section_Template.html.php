<?php /* Smarty version 2.6.18, created on 2017-01-29 22:58:47
...
<?php if ($this->_tpl_vars['section']['field']['display_style'] == 'inline'): ?>
	<?php $this->assign('table_tag', 'span'); ?>
	<?php $this->assign('tr_tag', 'span'); ?>
	<?php $this->assign('td_tag', 'span'); ?>
	<?php $this->assign('th_tag', 'span'); ?>
	<?php $this->assign('thead_tag', 'span'); ?>
	<?php $this->assign('tbody_tag', 'span'); ?>
<?php else: ?>
	<?php $this->assign('table_tag', 'table'); ?>
	<?php $this->assign('tr_tag', 'tr'); ?>
	<?php $this->assign('td_tag', 'td'); ?>
	<?php $this->assign('th_tag', 'th'); ?>
	<?php $this->assign('thead_tag', 'thead'); ?>
	<?php $this->assign('tbody_tag', 'tbody'); ?>
<?php endif; ?>
		<<?php echo $this->_tpl_vars['table_tag']; ?>
 width="100%" class="Dataface_QuickForm-table-wrapper xf-form-group <?php if ($this->_tpl_vars['section']['field']['display_style'] == 'inline'): ?>xf-form-group-inline<?php endif; ?> " data-xf-record-id="<?php echo ((is_array($_tmp=$this->_tpl_vars['form_record_id'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
">
...
?>
				...
				<<?php echo $this->_tpl_vars['tr_tag']; ?>
 id="<?php echo $this->_tpl_vars['element']['field']['name']; ?>
_form_row">
					<?php if ($this->_tpl_vars['element']['field']['widget']['template']): ?>
						<<?php echo $this->_tpl_vars['td_tag']; ?>
 colspan="2">
...
>
					<?php else: ?>
						<<?php echo $this->_tpl_vars['td_tag']; ?>
 <?php if ($this->_tpl_vars['element']['field']['display'] == 'block'): ?>colspan="2" class="Dataface_QuickForm-textarea-label-cell Dataface_QuickForm-block-label-cell"<?php endif; ?> valign="top" <?php if ($this->_tpl_vars['element']['field']['display'] != 'block'): ?>align="right" class="Dataface_QuickForm-label-cell"<?php endif; ?>>
...
>
						<<?php echo $this->_tpl_vars['td_tag']; ?>
 class="Dataface_QuickForm-widget-cell<?php if ($this->_tpl_vars['isText']): ?> Dataface_QuickForm-textarea-widget-cell<?php endif; ?>">
						<div class="field <?php if ($this->_tpl_vars['element']['error']): ?>error<?php endif; ?>" id="<?php echo $this->_tpl_vars['element']['field']['tablename']; ?>
-<?php echo $this->_tpl_vars['element']['field']['name']; ?>
-wrapper">
						<?php endif; ?>
