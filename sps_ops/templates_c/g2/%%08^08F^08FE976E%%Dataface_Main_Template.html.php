 ...
 ?><?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['define_slot'][0][0]->define_slot($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
				...
				<div id="top-menu-bar">
					<div id="top-right-menu-bar">
						<?php echo $this->_plugins['function']['actions_menu'][0][0]->actions_menu(array('category' => 'top_right_menu_bar','maxcount' => $this->_tpl_vars['G2']->get_property('top_right_menu_bar.size',4),'class' => 'right'), $this);?>

					</div>
				<?php if ($this->_tpl_vars['ENV']['prefs']['show_tables_menu']): ?>
					<div id="top-left-menu-bar">
						<?php echo $this->_plugins['function']['actions_menu'][0][0]->actions_menu(array('category' => 'top_left_menu_bar','maxcount' => $this->_tpl_vars['G2']->get_property('top_left_menu_bar.size',7)), $this);?>
...
"/>
													...
													<input class="xf-search-button" 
                                                                                                               type="submit" 
                                                                                                               name="-submit" 
                                                                                                               value='<?php $this->_tag_stack[] = array('translate', array('id' => "main.search.button.label",'tableObj' => $this->_tpl_vars['ENV']['table_object'])); $_block_repeat=true;$this->_plugins['block']['translate'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Search <?php echo ((is_array($_tmp=$this->_tpl_vars['ENV']['table_object']->getLabel())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['translate'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>' 
													...
													<a class="xf-show-advanced-find collapsed">
														<span class="collapsed"><?php $this->_tag_stack[] = array('translate', array('id' => "templates.G2.advanced_search.label")); $_block_repeat=true;$this->_plugins['block']['translate'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Advanced Search<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['translate'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></span>
														<span class="expanded"><?php $this->_tag_stack[] = array('translate', array('id' => "templates.G2.hide_advanced_search.label")); $_block_repeat=true;$this->_plugins['block']['translate'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Hide Advanced Search<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['translate'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></span>
													</a>
