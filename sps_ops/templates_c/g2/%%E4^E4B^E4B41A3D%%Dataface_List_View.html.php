...
smarty_core_load_plugins(array('plugins' => array(array('function', 'block', 'Dataface_List_View.html', 23, false),array('function', 'result_list', 'Dataface_List_View.html', 25, false),array('function', 'actions_menu', 'Dataface_List_View.html', 44, false),array('block', 'define_slot', 'Dataface_List_View.html', 24, false),array('block', 'use_macro', 'Dataface_List_View.html', 33, false),array('block', 'fill_slot', 'Dataface_List_View.html', 35, false),array('block', 'master_detail', 'Dataface_List_View.html', 36, false),array('block', 'master', 'Dataface_List_View.html', 36, false),array('block', 'translate', 'Dataface_List_View.html', 37, false),array('block', 'detail', 'Dataface_List_View.html', 93, false),array('modifier', 'escape', 'Dataface_List_View.html', 61, false),array('modifier', 'truncate', 'Dataface_List_View.html', 62, false),)), $this); ?>
...
<?php else: ?>
	<?php $this->_tag_stack[] = array('use_macro', array('file' => "Dataface_Main_Template.html")); $_block_repeat=true;$this->_plugins['block']['use_macro'][0][0]->use_macro($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		...
		<?php $this->_tag_stack[] = array('fill_slot', array('name' => 'main_section')); $_block_repeat=true;$this->_plugins['block']['fill_slot'][0][0]->fill_slot($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		    <?php $this->_tag_stack[] = array('master_detail', array('disabled' => $this->_tpl_vars['ENV']['prefs']['disable_master_detail'])); $_block_repeat=true;$this->_plugins['block']['master_detail'][0][0]->master_detail($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php $this->_tag_stack[] = array('master', array()); $_block_repeat=true;$this->_plugins['block']['master'][0][0]->master($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
...
">
			...
			<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['master'][0][0]->master($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
			<?php $this->_tag_stack[] = array('detail', array()); $_block_repeat=true;$this->_plugins['block']['detail'][0][0]->detail($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
			
			<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['detail'][0][0]->detail($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
			<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['master_detail'][0][0]->master_detail($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
