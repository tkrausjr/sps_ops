...
unset($_smarty_tpl_vars);
 ?></div>
			...
			<h3 class="edit-record-label"> <?php $this->_tag_stack[] = array('translate', array('id' => 'edit_new_x_y','x' => ((is_array($_tmp=$this->_tpl_vars['ENV']['table_object']->getSingularLabel())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)),'y' => ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['record']->getTitle())) ? $this->_run_mod_handler('truncate', true, $_tmp, 50) : smarty_modifier_truncate($_tmp, 50)))) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)))); $_block_repeat=true;$this->_plugins['block']['translate'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
                    Edit <?php echo ((is_array($_tmp=$this->_tpl_vars['ENV']['table_object']->getSingularLabel())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
