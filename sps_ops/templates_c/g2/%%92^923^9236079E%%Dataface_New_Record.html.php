<?php /* Smarty version 2.6.18, created on 2017-01-29 23:07:44
         compiled from Dataface_New_Record.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'use_macro', 'Dataface_New_Record.html', 20, false),array('block', 'fill_slot', 'Dataface_New_Record.html', 21, false),array('block', 'define_slot', 'Dataface_New_Record.html', 24, false),array('block', 'translate', 'Dataface_New_Record.html', 37, false),array('function', 'block', 'Dataface_New_Record.html', 23, false),array('function', 'actions_menu', 'Dataface_New_Record.html', 29, false),array('modifier', 'escape', 'Dataface_New_Record.html', 37, false),array('modifier', 'count', 'Dataface_New_Record.html', 42, false),)), $this); ?>
<?php $this->_tag_stack[] = array('use_macro', array('file' => "Dataface_Main_Template.html")); $_block_repeat=true;$this->_plugins['block']['use_macro'][0][0]->use_macro($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	<?php $this->_tag_stack[] = array('fill_slot', array('name' => 'main_section')); $_block_repeat=true;$this->_plugins['block']['fill_slot'][0][0]->fill_slot($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		...
		<h3 class="insert-record-label"> <?php $this->_tag_stack[] = array('translate', array('id' => 'insert_new_x','x' => ((is_array($_tmp=$this->_tpl_vars['ENV']['table_object']->getSingularLabel())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)))); $_block_repeat=true;$this->_plugins['block']['translate'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
                Insert New <?php echo ((is_array($_tmp=$this->_tpl_vars['ENV']['table_object']->getSingularLabel())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
