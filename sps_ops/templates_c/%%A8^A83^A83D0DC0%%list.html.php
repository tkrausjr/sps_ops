<?php /* Smarty version 2.6.18, created on 2017-02-13 20:51:47
			...
			<div class="xf-button-bar-actions">
				...
				<ul>
					...
					<?php if ($this->_tpl_vars['import_related_records_query'] && count($this->_tpl_vars['importTable']->getImportFilters()) > 0): ?>
						<li id="import">
							<a id="import_related_records" href="<?php echo ((is_array($_tmp=$this->_tpl_vars['import_related_records_link'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
">
...
<?php else: ?>
    ...
    <?php if (! $this->_tpl_vars['relatedList']->hideActions && ( $this->_tpl_vars['filterQuery'][$this->_tpl_vars['relatedSearchKey']] || $this->_tpl_vars['filters'] )): ?>
        <div class="related-filters">
        <?php $this->_tag_stack[] = array('translate', array('id' => "scripts.GLOBAL.RECORDS_MATCHED_REQUEST")); $_block_repeat=true;$this->_plugins['block']['translate'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Showing matches for query<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['translate'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
        <?php if (! $this->_tpl_vars['relatedList']->hideActions && $this->_tpl_vars['relatedList']->_where && $this->_tpl_vars['filterQuery'][$this->_tpl_vars['relatedSearchKey']]): ?>
            <span> Search: <em>&quot;<?php echo ((is_array($_tmp=$this->_tpl_vars['filterQuery'][$this->_tpl_vars['relatedSearchKey']])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
&quot;</em>
...
" title="<?php $this->_tag_stack[] = array('translate', array('id' => "scripts.GLOBAL.RECORDS_MATCHED_REMOVE")); $_block_repeat=true;$this->_plugins['block']['translate'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Remove this filter to show all records in this relationship<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['translate'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>">
                <img src="<?php echo ((is_array($_tmp=@DATAFACE_URL)) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
/images/delete.gif" alt="<?php $this->_tag_stack[] = array('translate', array('id' => "scripts.GLOBAL.RECORDS_MATCHED_REMOVE_SUBMIT")); $_block_repeat=true;$this->_plugins['block']['translate'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Remove filter<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['translate'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>" />
            </a>
            </span>
        <?php endif; ?>
...
?>
            <span><?php echo $this->_tpl_vars['filter']['field_label']; ?>
 <em>&quot;<?php echo ((is_array($_tmp=$this->_tpl_vars['filter']['field_display_value'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
&quot;</em>
            <a href="<?php echo ((is_array($_tmp=$this->_tpl_vars['filter']['url'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
